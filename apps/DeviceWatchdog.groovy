definition(
    ...
    importUrl: "https://raw.githubusercontent.com/Fernsatron83/Third-Reality-Gen-2-Smart-Plug-Device-Watchdog/claude/influxdb-device-logging-ymZfM/apps/DeviceWatchdog.groovy"
)
preferences {
    page(name: "mainPage")
